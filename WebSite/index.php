...
?>
  ...
  <div class="box" id="about">
    ...
    <h2>Important!</h2>
    <p>The 0.5.3 release is the most stable release and is recommended for
    new users. It <em>is</em> Tiger-compatible but no further development
    will be done on this branch. If you are willing to
    try incomplete code, you can try the <a href="ftp://ftp.berlios.de/pub/desktopmanager/DesktopManager.dmg">latest developer build</a>. 
